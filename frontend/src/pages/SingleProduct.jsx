...
import productImg from "../assets/productCard/product2.png";
...
function SingleProduct() {
  const product = {
    ...
    price: 4500,
    Description:
      "A high-rise jean with a wide leg, perfect for a trendy and comfortable look. A high-rise jean with a wide leg, perfect for a trendy and comfortable look.",
    size: ["22", "23", "24"],
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-12 px-5 ">
          ...
          <div className="md:col-span-6 col-span-12 h-150 bg-[#d9d7d1] flex justify-center items-center">
            <img src={productImg} className="w-150 h-150" alt={product.name} />
          </div>
          ...
          <div className="md:col-span-6 col-span-12 bg-[#d9d7d1] p-6 space-y-4">
            ...
            <div className="text-lg font-semibold ">LKR {product.price}.00</div>
            <div className="text-sm  text-[#223531] mb-2">
              Material - 100% cotton <br /> All sizes mentioned in inches
            </div>
            <div className="text-sm  text-[#223531] mb-8">
              {product.Description}
            </div>
