...
const Register = () => {
  return (
    <div className="bg-[#CAC7BF] min-h-screen grid grid-cols-12 items-center px-4">
      <div className="col-span-10 md:col-span-10  lg:col-span-8 lg:col-start-3 col-start-2 md:col-start-2 h-max bg-white rounded-2xl p-8 md:p-8 grid grid-cols-2 md:grid-cols-10 lg:grid-cols-6 gap-6 mt-4">
        <div className="col-span-2 md:col-span-5 lg:col-span-3">
          <div className="text-[28px] font-bold pb-1 text-[#223531]">
            Sign Up
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-3 pb-3">
            <div className="w-full">
              ...
              <input
                className="bg-[#e6e3db] w-full h-9 rounded-lg p-2 border-[#223531] border outline-none"
                type="text"
              />
            </div>
            <div className="w-full">
          ...
          {/* Sign Up Button */}
          <button className="w-full bg-[#223531] text-white h-9 rounded-lg mt-3 active:translate-y-0.5 cursor-pointer hover:bg-[#2c423d]">
            Sign Up
          </button>
           <div className="text-sm text-center pt-4">Already have an account? <a href=""><u>Login</u></a> </div>
        </div>
