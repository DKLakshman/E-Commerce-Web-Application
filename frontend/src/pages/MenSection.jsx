...
import Product1 from "../assets/menSection/ms2.png";
import Product2 from "../assets/menSection/ms1.png";
        ...
        <div className="lg:container mx-auto pt-10 pb-11">
          <div className="grid md:grid-cols-12 grid-cols-8 lg:gap-22 gap-10 md:p-0 p-3">
            <div className="col-span-8 md:col-span-5 md:col-start-2 col-start-1  bg-cover bg-center font-extrabold text-xl sm:text-3xl text-[#223531] rounded-2xl md:p-4 p-2 cursor-pointer transform transition hover:scale-101">
              <div className=""><img src={Product1} className="h-130 w-[100%] rounded-t-2xl" alt="" /></div>
              <div className="h-20  flex justify-center items-center bg-[#bbb8b0] rounded-b-2xl">T-Shirts</div>
            </div>
            <div
            ...
            >
            <div><img src={Product2} className="h-130  w-[100%] rounded-t-2xl" alt="" /></div>
              <div className="h-20  flex justify-center items-center bg-[#bbb8b0] rounded-b-2xl">Trousers</div>
            </div>
          </div>
        </div>
      </div>
